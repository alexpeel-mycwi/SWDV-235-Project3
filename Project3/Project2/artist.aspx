...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
   <div class="container row table-title">
    ...
    <br />
     ...
     <asp:SqlDataSource runat="server" ID="SqlDataSourceartistALL" ConnectionString='<%$ ConnectionStrings:disk_inventoryConnectionString %>' DeleteCommand="DELETE FROM [artist] WHERE [artist_ID] = @artist_ID" InsertCommand="INSERT INTO [artist] ([type_ID], [first_name], [last_name]) VALUES (@type_ID, @first_name, @last_name)" SelectCommand="SELECT * FROM [artist] ORDER BY [first_name]" UpdateCommand="UPDATE [artist] SET [type_ID] = @type_ID, [first_name] = @first_name, [last_name] = @last_name WHERE [artist_ID] = @artist_ID">
       <DeleteParameters>
